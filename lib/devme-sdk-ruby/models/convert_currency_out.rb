  ...
  class ConvertCurrencyOut
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DevmeSdk::ConvertCurrencyOut` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DevmeSdk::ConvertCurrencyOut`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'converted_text')
        self.converted_text = attributes[:'converted_text']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          converted_text == o.converted_text
    end
    ...
    def hash
      [from, to, exchange_rate, rate_time, original_amount, converted_amount, converted_text].hash
    end
